...
Este es el espejo en español de `CODE_OF_CONDUCT.md`. Ante una diferencia de
traducción, prevalece el texto en inglés.
...
periodo especificado de tiempo. Esto incluye evitar las interacciones en espacios
de la comunidad, así como a través de canales externos como las redes sociales.
...
encuentran aplicando el Código de Conducta, durante este periodo. Incumplir estos
...
Para respuestas a preguntas frecuentes, consulta
